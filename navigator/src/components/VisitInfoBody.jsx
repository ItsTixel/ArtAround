  ...
  return (
    <>
      <div className="relative flex h-[170px] shrink-0 items-center justify-center overflow-hidden border-b border-border bg-slate-400/10">
        ...
        {isInfra && (
          <span className="absolute left-3 top-3 z-[2] rounded-full bg-slate-400/10 px-2.5 py-1.5 font-mono text-[0.62rem] uppercase tracking-[0.16em] text-text shadow-xl shadow-black/5 backdrop-blur-lg border border-slate-400/20">
            Inframuseale
          </span>
        )}
        <span className="relative z-[1] max-w-[80%] truncate rounded-full bg-slate-400/10 px-3 py-1.5 text-center font-mono text-[0.68rem] uppercase tracking-[0.14em] text-text shadow-xl shadow-black/5 backdrop-blur-lg border border-slate-400/20">
          {visit.title}
        </span>
      </div>
